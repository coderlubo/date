...
相关请求仅用于完成功能本身，不用于广告追踪或用户画像。

### 4. 第三方服务

部分功能可能调用系统服务或第三方平台，例如微软商店更新渠道。这些服务的数据处理规则以其官方政策为准。
...
These requests are used only to complete the requested feature and not for ad tracking or user profiling.

### 4. Third-Party Services

Some features may call system services or third-party platforms, for example the Microsoft Store update channel. Data handling for those services follows their official policies.
